...
class TestWeeklyReportCoverImages:
    ...
    def test_default_summary_includes_cover_images(self):
        ...
        analysis = {
            'top_changes': [
                {'title': 'Test', 'author': 'A', 'rank_change': 3, 'cover': 'https://example.com/cover.jpg'}
            ],
            ...
            'longest_running': [
                {'title': 'Long', 'author': 'D', 'weeks_on_list': 20, 'cover': 'https://example.com/long.jpg'}
            ],
            'featured_books': [
                {'title': 'Feat', 'author': 'E', 'reason': '推荐', 'cover': 'https://example.com/feat.jpg'}
            ],
        }
