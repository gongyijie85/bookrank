...
def test_sensitive_info_leakage():
    ...
    sensitive_patterns = ['traceback', 'exception', 'error', 'stack', 'database', 'password', 'secret', 'api_key']
...
def test_cors_policy():
    ...
    # 测试跨域请求
    response = client.get('/reports/weekly', headers={'Origin': 'https://example.com'})
