...
def load_update_time() -> dict | None:
    """加载更新时间"""
    try:
...
def get_publishers():
    ...
    try:
        ...
        return APIResponse.success(data={'publishers': publishers})
    except Exception as e:
...
def get_new_books():
    ...
    try:
        ...
        paginated_books = all_books[start:start + per_page]
