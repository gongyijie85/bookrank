...
class UserFavorite(db.Model):
    ...
    __table_args__ = (
        ...
        db.Index('idx_user_favorites_session_created', 'session_id', 'created_at'),
    )
...
class BookMetadata(db.Model):
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            'details_zh': quick_clean_translation(self.details_zh, 'details'),
...
class TranslationCache(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('source_hash', 'source_lang', 'target_lang', name='uix_translation_source_target'),
        # 复合索引，用于高效查询
